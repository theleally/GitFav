...
export class FavoritesView extends Favorites {
  ...
  onadd() {
    const addButton = this.root.querySelector(".btn__favoritar");
    addButton.onclick = () => {
  ...
  createRow() {
    ...
    tr.innerHTML = `
      <td class="user">
      <img src="https://github.com/theleally.png" alt="" />
      <a href="https://github.com/theleally">
        <p>Leandro Allysson Joo</p>
        <span>theleally</span>
      </a>
      </td>
